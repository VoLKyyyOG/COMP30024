...
python -m referee -l logs/sample/red_slow.txt player.mix player.slow player.slow
python -m referee -l logs/sample/green_slow.txt player.slow player.mix player.slow
python -m referee -l logs/sample/blue_slow.txt player.slow player.slow player.mix
